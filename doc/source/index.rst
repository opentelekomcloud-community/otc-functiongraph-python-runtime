FunctionGraph Python documentation
===============================================

This is the **FunctionGraph Python Development Guide** for running
FunctionGraph.
...
For source code, see :github_repo_master:`otc-functiongraph-python-runtime<>` on GitHub.
