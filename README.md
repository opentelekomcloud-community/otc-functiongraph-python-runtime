...
For documentation see: [otc-functiongraph-python-runtime](https://opentelekomcloud-community.github.io/otc-functiongraph-python-runtime/)
...
>  tox -e docs-auto
>  ```
> Open documentation in browser: <http://127.0.0.1:8890>
